...
registry_external_url 'http://100.16.0.53:5555'
#registry_nginx['ssl_certificate'] = "/etc/gitlab/ssl/100.16.0.53.crt"
#registry_nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/100.16.0.53.key"
...
# letsencrypt['contact_emails'] = ['raymondhliu@hotmail.com'] # This should be an array of email addresses to add as contacts
